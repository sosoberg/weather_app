...
function printResults(resultObj) {
    ...
    var tempContent = document.textContent.createElement('p');
    tempContent.id('tempature');
    tempContent.innerHTML = '<strong>Tempature:</strong> ' + resultObj.data.main.temp;

    var humidContent = document.textContent.createElement('p');
    humidContent.id('humidity');
    humidContent.innerHTML = '<strong>Humidity:</strong> ' + resultObj.data.main.humidity;

    var windContent = document.textContent.createElement('p');
    windContent.id('windSpeed');
...
console.log(searchAPI('temp', 'Houston'));
